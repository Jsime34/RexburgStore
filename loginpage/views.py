...
def store_view(request):
    ...
    categories = [choice[0] for choice in Listing.CATEGORY_CHOICES]
    ...
    return render(request, 'loginpage/store.html', context)
...
def create_listing(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            listing.save()
            messages.success(request, "Listing created successfully!", extra_tags="listing_created")
...
def edit_profile(request):
    ...
    return render(request, "loginpage/edit_profile.html", {
