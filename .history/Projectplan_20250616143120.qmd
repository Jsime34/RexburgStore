...
* [x] Login/logout
* [] Require login to post listings
...
* [ ] Title, description, price, created\_at, seller
* [ ] Create listing form
* [ ] Add listing creation view (with `@login_required`)
* [ ] Listing template with SweetAlert2 success popup

### 📄 Viewing & Browsing

* [ ] Show all listings on homepage
* [ ] Item detail page (`/listing/<id>/`)
* [ ] Filter by category 
...
* [ ] Media setup for images (upload and preview)
